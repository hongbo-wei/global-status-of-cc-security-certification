...
<p align="center"><h1 align="center">100+ Big Data Visualization Templates</h1></p>
...
#### Project Background
Since my company’s project uses a large data visualization web app, I have found various resources on Google on the Internet, and most of them are charged, even the ones that charge for each page, regardless of whether they are paid I still collected a lot for free, so I plan to sort it out and share it with everyone for free, so that everyone will not go the wrong way again. If you have good templates that you have treasured, you are welcome to continue to add and contribute! ! !


```
If you feel it is useful，please 💘Star💘 the project for support, thank you!
```
...
1.Gitee directly clones and downloads, and uses a browser to access the static page.

```
git clone https://gitee.com/iGaoWei/big-data-view.git
```

2.GitHub directly clones and downloads, and uses a browser to access the static page.
```
...
#### Screenshot Preview
```
When previewing online, the page may be incompatible and cannot be displayed normally due to the GithubPages browser environment problem. Please refer to the screenshot, or download it to the local test preview. Thank you for your support!
```
##### 001 Government Service Big Data Visualization Supervision Platform [Online Preview](https://igaowei.github.io/BigDataView/web/001%20%E6%9C%8D%E5%8A%A1%E5%A4%A7%E6%95%B0%E6%8D%AE%E5%8F%AF%E8%A7%86%E5%8C%96%E7%9B%91%E7%AE%A1%E5%B9%B3%E5%8F%B0/)
...
#### Reminder: More templates are being updated one after another
